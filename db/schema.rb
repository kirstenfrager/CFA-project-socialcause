...
ActiveRecord::Schema.define(version: 20170424033859) do
  ...
  create_table "auctions", force: :cascade do |t|
    ...
    t.datetime "ends_at"
    t.boolean  "paid"
    t.index ["photograph_id"], name: "index_auctions_on_photograph_id", using: :btree
  end
  ...
  create_table "photographs", force: :cascade do |t|
    ...
    t.index ["slug"], name: "index_photographs_on_slug", unique: true, using: :btree
  ...
  add_foreign_key "auctions", "photographs"
